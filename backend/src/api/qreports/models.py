...
class SAP_ItemRequest(db.Model):

    __bind_key__ = "qreports"
    __tablename__ = 'SAP_ItemRequest'
...
# Input by User Fields:
    ...
    item_group_name   = db.Column(db.NVARCHAR(100), nullable=True)
    ...
    uom_name          = db.Column(db.NVARCHAR(250), nullable=True)
    brand_name        = db.Column(db.NVARCHAR(100), nullable=True)
    medecine_type     = db.Column(db.NVARCHAR(100), nullable=True)
