...
import { SEARCH_CURRENT_REQUEST_API } from "../../utils/endPoint";

const BURequestSearchButton = ({ setBUSearch, setBuSubmit }) => {
  const [isOpen, setIsOpen] = useState(false);
  const handleClick = (bu) => {
    setBuSubmit(bu);
    setBUSearch(SEARCH_CURRENT_REQUEST_API[bu]);
    setIsOpen(false);
  };
  return (
...
export default BURequestSearchButton;
