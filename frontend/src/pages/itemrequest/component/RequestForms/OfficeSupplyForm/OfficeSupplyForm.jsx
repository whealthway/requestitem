...
const OfficeSupplyForm = ({ register, control, uoms }) => {
  return (
    <div className="my-1 p-4 w-full justify-start border rounded-md border-l-4 border-l-red-300">
      ...
      <div className="flex flex-wrap gap-6 my-4 pb-3 border-b-4 rounded-sm">
        ...
        <div className="">
          ...
          <div>
            <TextField register={register} name="usage" />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-6 my-4 pb-3 border-b-4 rounded-sm">
        ...
        <div className="">
          ...
          <div>
            <TextField register={register} name="materialProperties" />
          </div>
        </div>
        <div className="">
          <div>
